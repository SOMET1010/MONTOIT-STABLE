...
import { ChevronLeft, ChevronRight, CheckCircle, AlertCircle, Save, User, Shield, FileText, FolderOpen } from 'lucide-react';
...
const ApplicationWizard: React.FC<{ propertyId: string }> = ({ propertyId }) => {
  ...
  const calculateApplicationScore = (): ApplicationScore => {
