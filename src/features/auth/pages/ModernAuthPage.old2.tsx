                ...
                <div className="animate-fade-in">
                  ...
                  <form onSubmit={handleSendOTP} className="space-y-6">
                    ...
                    <button
                      ...
                      className="w-full py-4 px-6 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-2xl font-semibold text-lg
                        hover:from-orange-700 hover:to-red-700 active:scale-98 disabled:opacity-50 disabled:cursor-not-allowed
